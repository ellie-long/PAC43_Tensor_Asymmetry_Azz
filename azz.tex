...
\begin{center}
 \LARGE{
  Measurement of the Tensor Asymmetry $A_{zz}$ from $0.3<x<1.9$ and Elastic $T_{20}$
 }
\end{center}
%
...
\input{input/pac42_concerns.tex}
